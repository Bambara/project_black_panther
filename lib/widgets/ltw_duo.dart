...
class ListTileWidgetDuo extends StatelessWidget {
  const ListTileWidgetDuo({Key? key, required this.duoTeam, required this.index, required this.function, required this.navigate}) : super(key: key);
        ...
        child: Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [
          Container(
            ...
            decoration: const BoxDecoration(
                gradient: LinearGradient(colors: [Colors.purple, Colors.redAccent], begin: Alignment.centerLeft, end: Alignment.centerRight), borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Column(
