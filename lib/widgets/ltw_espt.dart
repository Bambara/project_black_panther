...
//LTWEAPlayerTeam - LTWEventAssignedPlayerTeam
class LTWEAPlayerTeam extends StatelessWidget {
  ...
  final Function(EventTeamAssign) remove;

  ///Event Assigned Player Team List Tile Widget
  ///
  const LTWEAPlayerTeam({
    Key? key,
        ...
        child: Stack(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(onTap: () => remove.call(assignedTeams[index]), child: const SVGIconWidget(path: Assets.iconsDelete, sizeFactor: 0.045)),
                        ],
                      )
                    ],
                  ),
            ...
            Positioned(
              ...
              left: screenHeight * 0.01,
              child: assignedTeams[index].cardColor == 'Green'
                  ? const GFBadge(
                      size: GFSize.LARGE,
                      shape: GFBadgeShape.standard,
                      color: Colors.green,
                    )
                  : assignedTeams[index].cardColor == 'Yellow'
                      ? const GFBadge(
                          size: GFSize.LARGE,
                          shape: GFBadgeShape.standard,
                          color: Colors.yellow,
