...
///LTWPlayerGame - ListTileWidgetPlayerGame
class LTWPlayerGame extends StatelessWidget {
  ...
  const LTWPlayerGame({Key? key, required this.artWorks, required this.index, required this.function, required this.removeItem, required this.navigate}) : super(key: key);
